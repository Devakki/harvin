...
$(document).ready(function(){
    ...
    var oTable = $('.project-datatable').DataTable({
            ...
            columns: [
                ...
                { data: 'image', name: 'image', searchable: false, orderable:false, width: 100},                                                                             
                { data: 'link', name: 'link'},                                                   
                { data: 'snipet', name: 'snipet', searchable: false, orderable:false, width: 100},                                                   
                {
                    data:  null,
                    orderable: false,
                    searchable: false,
                    ...
                    render:function(o){
                        ...
                        btnStr += "<a href='{!!  $module_route  !!}/"+  o.id +"/edit' title='Edit'>Edit</a>  <a href='javascript:void(0);' class='deleteRecord' val='" + o.id + "' title='Delete' >Delete</a><a href='javascript:void(0);' class='copysnippet' >Copy snippet</a>";
    ...
    jQuery(document).on('click', '.copysnippet', function(event) {
        var parent = $(this).parents('tr').find('.badge_snippet').select();
