...
<div class="form-group row duke-host-name-list-main">
    <div class="col-sm-6">
        ...
        {{ Form::select('blog_category_id', [ "" => "Select"] + $categories, null, ['id'=> 'blog_category_id', 'class' => 'form-control select2']) }}
...
<div class="form-group row duke-host-name-list-main">
    ...
    <label>Hashtags</label>
        {{ Form::select('hashtags[]', $hashtags, ( isset($selectedCategories) && count($selectedCategories))?$selectedCategories:null, ['id'=> 'hashtags', 'class' => 'form-control select2', 'multiple' => 'multiple']) }}
...
<div class="form-group row">
    <div class="col-sm-6 duke-featured-topic">
        {{ Form::checkbox('is_popular', null, null, ['id' => 'is_popular' ]) }}
        <label for="is_popular">Popular Blog</label>
        @if($errors->has('is_popular'))
            <p class="text-danger">{{ $errors->first('is_popular') }}</p>
        @endif
    </div>
</div>
...
<div class="form-group row">
    <div class="col-sm-6 duke-featured-topic">
        {{ Form::checkbox('is_slider', null, null, ['id' => 'is_slider' ]) }}
        <label for="is_slider">Top Blog</label>
        @if($errors->has('is_slider'))
            <p class="text-danger">{{ $errors->first('is_slider') }}</p>
        @endif
    </div>
</div>
