...
@section('content')
    <div class="greenplaces-main">
        <section class="greenplaces-banner-wrapper greenp-aboutus-banner-section">
            <div class="container-fluid">
                <div class="row">
                    <div class="offset-md-1 offset-lg-1 offset-xl-1 col-md-6 col-lg-5 col-xl-5">
                    ...
                    @else
                        <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-duration="1500">
                            <div class="greenp-partner-employee-list">
                                ...
                                <ul class="greenp-social-icon">
                                    <li><a href="{{ $team->linkedin }}"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                    <li><a href="mailto:{{ $team->email }}"><i class="fa fa-envelope-o" aria-hidden="true"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
