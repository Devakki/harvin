        ...
        <section class="greenplaces-terms-page">
            <div class="container">
                <div class="greenplaces-terms-wrapper">
                    <h3 class="greenp-subtitle-small">TERMS AND CONDITIONS</h3>
                    <p class="greenp-paragraph-text">This Terms and Conditions agreement (the "Agreement") applies to each customer (the “Customer”) that accepts a proposal from GREEN PLACES, LLC. ("GREEN PLACES") and constitutes a binding contract between such Customer and GREEN PLACES. </p>
                    <div class="">
                        <h5>1 Customer Responsibilities and Representations.</h5>
                        <ol>
                            <li>Customer agrees to:</li>
                            <ol>
                        ...
                        <h5>2 Trademark Authorization.</h5>
                        <h6>GREEN PLACES hereby grants to Customer the following rights under the Licensed Marks.</h6>
                        <ol>
                        ...
                        <h5>3 Term and Termination</h5>
                            <ol>
                                ...
                                <ol>
                                    ...
                                    <li>Upon any termination of this Agreement: (a) all rights and licenses granted to Customer hereunder for the Licensed Marks shall terminate and Customer shall cease all use of the Licensed Marks and (b) the licenses granted to GREEN PLACES pursuant to Section 1.2 of this Exhibit A shall survive.</li>
                                </ol>
                            </ol>
                        <h5>4 General</h5>
                        <ol>
                        ...
                        <h5>5 Definitions.</h5>
                        <h6>The following terms shall have the following meanings in this Agreement.</h6>
                        <ol>
