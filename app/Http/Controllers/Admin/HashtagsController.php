...
use App\Http\Requests\Admin\HashtagRequest;
...
class HashtagsController extends Controller
{
    ...
    {        
        $this->moduleName = "Hashtag";
        $this->moduleRoute = url('admin/hashtags');
        $this->moduleView = "admin.main.hashtags";
        $this->model = $model;
    ...
    public function update(HashtagRequest $request, $id)
    {                       
        $input = $request->except(['_token']);
        try {
            $result = $this->model->find($id);            
